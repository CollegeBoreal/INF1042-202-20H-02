...
d'un petit jeu de roulette très simplifié dans lequel vous pourrez miser une certaine somme et gagner ou perdre de l'argent (telle est la fortune, au casino !).
...
try :
    argent = int(input("veuillez inserez votre montant d'entrez de jeu (celui doit être > 500) : "))   # declarer votre revenu pour le jeu
    assert argent > 500                     # celui-ci doit être superieur à 500
...
except AssertionError :                         # lève l'exception de la petite mise ( inferieur à 500)
    print("valeur inferieur au minimun du jeu")
